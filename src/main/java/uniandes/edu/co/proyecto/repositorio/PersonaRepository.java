...
public interface PersonaRepository extends JpaRepository<Persona, Integer> {
    ...
    @Modifying
    @Transactional
    @Query(value = "INSERT INTO PERSONAS (ID, NOMBRE, DATOSCONTACTO, DIRECCIONFISICA, DIRECCIONELECTRONICA, TELEFONO, CIUDAD, DEPARTAMENTO, CODIGOPOSTAL, FECHAREGISTRO, DOCID ) VALUES (personas_sequence.nextval, :NOMBRE, :DATOSCONTACTO, :DIRECCIONFISICA, :DIRECCIONELECTRONICA, :TELEFONO, :CIUDAD, :DEPARTAMENTO, :CODIGOPOSTAL, :FECHAREGISTRO, :DOCID)", nativeQuery=true)
        void insertarPersona(@Param("NOMBRE") String NOMBRE, @Param("DATOSCONTACTO") String DATOSCONTACTO, @Param("DIRECCIONFISICA") String DIRECCIONFISICA,@Param("DIRECCIONELECTRONICA") String DIRECCIONELECTRONICA, @Param("TELEFONO") int TELEFONO,@Param("CIUDAD") String CIUDAD,@Param("DEPARTAMENTO") String DEPARTAMENTO,@Param("CODIGOPOSTAL") int codigoPostal,@Param("FECHAREGISTRO") Date FECHAREGISTRO, @Param("DOCID") int DOCID);
